...
import no.digdir.catalogadmin.service.CodeListService
...
class ConceptSubjectsController(private val codeListService: CodeListService) {
    ...
    fun getConceptSubjectsForCatalogRDF(@PathVariable catalogId: String): ResponseEntity<String> = codeListService
    ...
    fun getConceptSubjectsForCatalog(@PathVariable catalogId: String): ResponseEntity<CodeList> = codeListService
