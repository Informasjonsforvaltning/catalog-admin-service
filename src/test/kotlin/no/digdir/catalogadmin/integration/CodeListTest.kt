...
import no.digdir.catalogadmin.model.CodeLists
import no.digdir.catalogadmin.model.JsonPatchOperation
import no.digdir.catalogadmin.model.OpEnum
import no.digdir.catalogadmin.utils.ApiTestContext
import no.digdir.catalogadmin.utils.CODE
import no.digdir.catalogadmin.utils.CODE_LIST_0
import no.digdir.catalogadmin.utils.CODE_LIST_2
import no.digdir.catalogadmin.utils.CODE_LIST_3
import no.digdir.catalogadmin.utils.CODE_LIST_TO_BE_CREATED_0
import no.digdir.catalogadmin.utils.LIST_OF_CODE_LISTS_TO_BE_CREATED
import no.digdir.catalogadmin.utils.NAME
import no.digdir.catalogadmin.utils.apiAuthorizedRequest
import no.digdir.catalogadmin.utils.apiGet
import no.digdir.catalogadmin.utils.jwk.Access
import no.digdir.catalogadmin.utils.jwk.JwtToken
...
class CodeListTest : ApiTestContext() {
    ...
    fun importThreeCodeLists() {
        ...
        val getResponse =
            apiAuthorizedRequest("/910244132/concepts/code-lists", port, null, JwtToken(Access.ORG_READ).toString(), HttpMethod.GET)
        assertEquals(HttpStatus.OK.value(), getResponse["status"])
